...
export const state = {
  ...
  // LLM 意图协议 Shadow 统计；仅用于管理观测，不参与用户请求结果。
  adminIntentShadowStats: null,
  adminSection: 'overview',
  adminAttractionQuery: '',
  adminAttractionCategory: '',
  adminUserRoleFilter: '',
  adminUserQuery: '',
  adminDocQuery: '',
  adminDocTopic: '',
  ...
  profile: null,
  useMemoriesInPlan: true,
  // 页面级请求状态：不再用一个全局 loading 阻塞所有页面，避免点击后只能等待。
  planningRequestActive: false,
  // A failed new-plan request must not make the previous draft look freshly generated.
